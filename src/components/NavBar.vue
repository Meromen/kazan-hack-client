...
.nav-bar {
  height: 5%;
  background: linear-gradient(90deg, #000000 1.56%, rgba(0, 0, 0, 0.41) 51.36%, #000000 100%), #292D39;
  padding: 0 4%;
  display: flex;
